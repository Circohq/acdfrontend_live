        ...
        <div className="footer_holder container">
          ...
          <div className="lowerfooter">
            <div className="resources">
              ...
              <p>
                <a
                  target="_blank"
                  href="https://inclusivefriends.org/publications"
                >
                  Our Research
                </a>
              </p>
            ...
            <div className="company">
              ...
              <p>
                <a target="_blank" href="https://inclusivefriends.org/whoweare">
                  About Us
                </a>
              </p>
              <p>
                <a target="_blank" href="mailto:info@inclusivefriends.org">
                  Career
                </a>
              </p>
              <p>
            ...
            <div className="contact_us">
              ...
              <div className="essentials">
                <p>
                  ...
                  1 Patricia Etteh Close, Wuye, Abuja 900108, Federal Capital
                  Territory
                </p>
          ...
          <div className="footerextra">
            ...
            <p>
              ...
              <a target="_blank" href="mailto:circohq@gmail.com">
                Developed with &#10084; by The Circo Team{" "}
              </a>
            </p>
          </div>
        </div>
