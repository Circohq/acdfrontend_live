export default function Faq() {
  return <section className="facts container lg:mb-20" id="_faqs">
      ...
      <div className="questions">
        ...
        <p className="hidden_answer">
          ...
          disabilities equal opportunity to use it independently as would
          persons without disabilities. It entails the use of accessible aids,
      ...
      <div className="questions">
        ...
        <p className="hidden_answer">
          ...
          accessible transportation for persons with disabilities whether by
          road, sea, rail, or air. It is to the effect that means and
          facilities of transportation shall be accessible to person s with
          disabilities, including maintaining the &quot;cab-rank-rule&quot; in
          respect of goods and services, accessibility of vehicles, provision
          of facilities such as lifts, ramps, and other accessibility aids to
          enhance disability inclusive transportation, reserved spaces, and
      ...
      <div className="questions">
        ...
        <p className="hidden_answer">
          ...
          accessible companies/organisation&apos;s will receive certification
          in the future. Being a certified inclusive/accessible
          company/organisation is a testament to your organisation&apos;s
      ...
      <div className="questions">
        ...
        <p className="hidden_answer">
          ...
          challenges of the over 30 million persons with disabilities in
          Nigeria through advocacy, training and research. At IFA, Disability
          Inclusion is at the core of our programming. And our five thematic
          areas are Humanitarian Peace & Conflict, Economic Empowerment,
          Democracy & Good Governance, Gender, and (Inclusive) Education
          (HEDGE). The Accessibility Compliance Dashboard is one of IFA&apos;s
          pioneering initiative to help monitor the implementation of the
